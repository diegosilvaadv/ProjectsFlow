...
class _ConfirmarEmailWidgetState extends State<ConfirmarEmailWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ConfirmarEmail'});
    _model.seunomeMobileController ??= TextEditingController();
    _model.seunomeMobileFocusNode ??= FocusNode();

    _model.seunomeDesktopController ??= TextEditingController();
    _model.seunomeDesktopFocusNode ??= FocusNode();
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'CONFIRMAR_EMAIL_PAGE_Button-Login_ON_TAP');
                                                logFirebaseEvent(
                                                ...
                                                child: TextFormField(
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primary,
                                                  validator: _model
                                                      .seunomeDesktopControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ),
