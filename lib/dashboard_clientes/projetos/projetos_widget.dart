...
class ProjetosWidget extends StatefulWidget {
  const ProjetosWidget({Key? key}) : super(key: key);

  @override
  _ProjetosWidgetState createState() => _ProjetosWidgetState();
}
...
class _ProjetosWidgetState extends State<ProjetosWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Projetos'});
                        ...
                        child: StreamBuilder<List<PagamentosRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<PagamentosRecord>
                                maxWidthPagamentosRecordList = snapshot.data!;
                            return Container(
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 0.0),
                                                  child: Text(
                                                    'Adicione Projetos para vender no PROJECTS FLOW.',
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .labelMedium,
                                                  ),
                          ...
                          child: StreamBuilder<List<ProjetosRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return MasonryGridView.builder(
                                ...
                                itemCount:
                                    staggeredViewProjetosRecordList.length,
                                itemBuilder: (context, staggeredViewIndex) {
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'PROJETOS_PAGE_Container_7en3tcbh_ON_TAP');
                                        logFirebaseEvent(
