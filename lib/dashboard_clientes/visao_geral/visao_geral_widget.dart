                                    ...
                                    children: [
                                      Expanded(
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'VISAO_GERAL_Container_steqy92z_ON_TAP');
                                            logFirebaseEvent(
                                      ...
                                      Expanded(
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'VISAO_GERAL_Container_4vxgh5ii_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_set_dark_mode_settings');
                                            setDarkModeSetting(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'VISAO_GERAL_PAGE_Icon_zg0vr77a_ON_TAP');
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          'Não existe valor minimo para solicitar saque.',
                                                                          style:
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'Veja as vendas mais recentes abaixo.',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .labelMedium,
                                                                ),
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  return ListView
                                                                    ...
                                                                    itemBuilder:
                                                                        (context,
                                                                            listViewIndex) {
                                                                      final listViewPagamentosRecord =
                                                                          listViewPagamentosRecordList[
                                                                              listViewIndex];
                                                                      return Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                                                          ...
                                                                                          child: Padding(
                                                                                            ...
                                                                                            child: Column(
                                                                                              ...
                                                                                              children: [
                                                                                                Text(
                                                                                                  valueOrDefault<String>(
                                                                                                    listViewPagamentosRecord.nomePagante,
                                                                                                    'NomePagante',
                                                                                                  ),
