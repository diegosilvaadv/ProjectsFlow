...
class _EditProjetosWidgetState extends State<EditProjetosWidget> {
  ...
  void initState() {
    ...
    _model.descriCompraController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.detalhesEdit?.descriVenda,
      'descV',
    ));
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'EDIT_PROJETOS_PAGE_Image_53yp16qy_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_expand_image');
                                                                        await Navigator
                                                                            .push(
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        logFirebaseEvent(
                                                                            'EDIT_PROJETOS_PAGE_Image_ysl5mbdq_ON_TAP');
                                                                        logFirebaseEvent(
                                                                            'Image_expand_image');
                                                                        await Navigator
                                                                            .push(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'EDIT_PROJETOS_PAGE_VISUALIZAR_BTN_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Button_bottom_sheet');
                                                  ...
                                                  Column(
                                                    ...
                                                    children: [
                                                      InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'EDIT_PROJETOS_Container_gagi6ou8_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Container_upload_media_to_supabase');
                                                          final selectedMedia =
                                                              await selectMedia(
                                                              ...
                                                              Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'EDIT_PROJETOS_content_copy_ICN_ON_TAP');
                                                                    logFirebaseEvent(
