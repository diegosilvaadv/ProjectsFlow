...
class SaquesWidget extends StatefulWidget {
  const SaquesWidget({Key? key}) : super(key: key);

  @override
  _SaquesWidgetState createState() => _SaquesWidgetState();
}

class _SaquesWidgetState extends State<SaquesWidget> {
  late SaquesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaquesModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Saques'});
                  ...
                  child: Align(
                    ...
                    child: StreamBuilder<List<PagamentosRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<PagamentosRecord> maxWidthPagamentosRecordList =
                            snapshot.data!;
                        return Container(
