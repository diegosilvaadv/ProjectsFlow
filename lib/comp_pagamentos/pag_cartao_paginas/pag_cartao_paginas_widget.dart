...
import 'pag_cartao_paginas_model.dart';
export 'pag_cartao_paginas_model.dart';

class PagCartaoPaginasWidget extends StatefulWidget {
  const PagCartaoPaginasWidget({
    Key? key,
  ...
  @override
  _PagCartaoPaginasWidgetState createState() => _PagCartaoPaginasWidgetState();
}

class _PagCartaoPaginasWidgetState extends State<PagCartaoPaginasWidget> {
  late PagCartaoPaginasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagCartaoPaginasModel());
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PAG_CARTAO_PAGINAS_COMP_close_ICN_ON_TAP');
                                      logFirebaseEvent(
                                                                      ...
                                                                      children: [
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              logFirebaseEvent('PAG_CARTAO_PAGINAS_SELECIONAR_BTN_ON_TAP');
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PAG_CARTAO_PAGINAS_ADICIONAR_NOVO_CARTÃO');
                                      logFirebaseEvent(
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'PAG_CARTAO_PAGINAS_REALIZAR_PAGAMENTO_BT');
