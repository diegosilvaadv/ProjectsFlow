...
import 'pag_pix_projetos_model.dart';
export 'pag_pix_projetos_model.dart';

class PagPixProjetosWidget extends StatefulWidget {
  const PagPixProjetosWidget({
    Key? key,
  ...
  @override
  _PagPixProjetosWidgetState createState() => _PagPixProjetosWidgetState();
}

class _PagPixProjetosWidgetState extends State<PagPixProjetosWidget> {
  late PagPixProjetosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PagPixProjetosModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('PAG_PIX_PROJETOS_pagPix_projetos_ON_INIT');
      logFirebaseEvent('pagPix_projetos_timer');
      _model.timerController.onStartTimer();
      logFirebaseEvent('pagPix_projetos_custom_action');
            ...
            await showAlignedDialog(
              ...
              builder: (dialogContext) {
                return Material(
                  ...
                  child: WebViewAware(
                      child: PagComSucessProjetosWidget(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'PAG_PIX_PROJETOS_COMP_close_ICN_ON_TAP');
                                          logFirebaseEvent(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'PAG_PIX_PROJETOS_Image_5q8znl4e_ON_TAP');
                                          logFirebaseEvent(
                                              'Image_expand_image');
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FlutterFlowTimer(
                              ...
                              onEnded: () async {
                                logFirebaseEvent(
                                    'PAG_PIX_PROJETOS_Timer_ew6m2h02_ON_TIMER');
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PAG_PIX_PROJETOS_content_copy_ICN_ON_TAP');
                                      logFirebaseEvent(
