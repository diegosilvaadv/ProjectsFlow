                ...
                children: [
                  ...
                  if (currentUserEmail != '')
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('APP_BAR_COMP_PERFIL_BTN_ON_TAP');
                          logFirebaseEvent('Button_update_app_state');
                          setState(() {
                  ...
                  if (currentUserEmail != '')
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent('APP_BAR_COMP_COMPRAS_BTN_ON_TAP');
                          logFirebaseEvent('Button_update_app_state');
                          setState(() {
                  ...
                  if (currentUserEmail == '')
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('APP_BAR_COMP_CRIAR_CONTA_BTN_ON_TAP');
                        logFirebaseEvent('Button_navigate_to');
                  ...
                  if (currentUserEmail != '')
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('APP_BAR_COMP_DASHBOARD_BTN_ON_TAP');
                        logFirebaseEvent('Button_update_app_state');
                        setState(() {
