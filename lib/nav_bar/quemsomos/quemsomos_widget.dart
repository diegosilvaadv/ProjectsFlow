...
import 'quemsomos_model.dart';
export 'quemsomos_model.dart';

class QuemsomosWidget extends StatefulWidget {
  const QuemsomosWidget({Key? key}) : super(key: key);

  @override
  _QuemsomosWidgetState createState() => _QuemsomosWidgetState();
}
...
class _QuemsomosWidgetState extends State<QuemsomosWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Quemsomos'});
