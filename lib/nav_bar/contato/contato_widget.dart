                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () async {
                                                                              logFirebaseEvent('CONTATO_PAGE_Icon_7470ms8e_ON_TAP');
                                                                              logFirebaseEvent('Icon_copy_to_clipboard');
                                                                              await Clipboard.setData(ClipboardData(text: 'DESCONTO50OFF'));
                                                                            },
                                                                            child:
                                                                                Icon(
                                                                              Icons.content_copy,
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'CONTATO_PAGE_Image_rucjmsb7_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'Image_expand_image');
                                                              await Navigator
                                                                  .push(
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'CONTATO_PAGE_Icon_lm1dgzqr_ON_TAP');
                                                                          logFirebaseEvent(
                                                                              'Icon_copy_to_clipboard');
                                                                          await Clipboard.setData(
                                                                              ClipboardData(text: 'FLUTTERFLOW50OFF'));
                                                                        },
                                                                        child:
                                                                            Icon(
                                                                          Icons
